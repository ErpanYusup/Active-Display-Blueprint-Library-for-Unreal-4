...
#include "Engine.h"
#include "SWindow.h" // For Newer Version of Unreal, Use Widgets/SWindow.h instead
...
*  15 / 04 / 2022 : added comment for newer version of Unreal
*  09 / 04 / 2023 : tidy up some typo for more readablitiry.
